                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">患者账单&nbsp&nbsp</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach items="${billList}" var="bil" >
                                    <tr role="row" class="odd">
                                        <td>${bil.medicalRecord.userId}</td>
                                        <td>${bil.medicalRecord.user.userName}</td>
                                        <td>${bil.billTime}</td>
                                        <td>${bil.medicalRecord.user.userPhone}</td>
                                        <c:if var="Accept" test="${bil.billAs==0}">
                                            <td>
                                                <a href="#" type="button" class="btn btn-primary btn-xs" disabled="disable">未支付</a>
                                            </td>
                                        </c:if>
                                        <c:if var="Accept" test="${bil.billAs==1}">
                                            <td>
                                                <a href="#" type="button" class="btn btn-danger btn-xs" disabled="disable">已支付</a>
                                            </td>
                                        </c:if>
                                        <td>${bil.billSum}</td>
                                        <td>
                                            <a href="/bill/viewBillList?userId=${bil.medicalRecord.userId}" type="button" class="btn btn-primary btn-xs">详情</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
