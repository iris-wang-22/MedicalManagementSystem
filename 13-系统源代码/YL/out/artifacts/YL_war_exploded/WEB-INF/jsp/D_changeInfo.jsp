            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#">权限管理</a></li>
                        <li><a href="#">职工注册</a></li>
                        <li class="active"><a href="/staff/D_changeInfo">资料修改</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        <form:form action="change" method="post" modelAttribute="staff">
                        <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">请确认信息修改完成</h3>
                        </div>
                        <div class="box-body">
                            <!-- Date -->
                            <div class="btn">
                                <button type="submit" class="btn btn-google"><b>确认修改</b></button>
                            </div>
