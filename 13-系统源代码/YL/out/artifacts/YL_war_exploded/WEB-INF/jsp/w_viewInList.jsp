        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="/inhospital/w_viewInList">查看病历</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="/bill/w_viewBillList">查看患者账单</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">患者清单&nbsp&nbsp</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <c:forEach items="${inhospitalList}" var="in" >
                                    <tr role="row" class="odd">
                                        <td>${in.userId}</td>
                                        <td>${in.user.userName}</td>
                                        <td>${in.user.userSex}</td>
                                        <td>${in.user.userAge}</td>
                                        <td>${in.ward.adId}</td>
                                        <c:if var="Accept" test="${in.inStatue==0}">
                                            <td>
                                                <a href="#" type="button" class="btn btn-primary btn-xs" disabled="disable">未入院</a>
                                            </td>
                                        </c:if>
                                        <c:if var="Accept" test="${in.inStatue==1}">
                                            <td>
                                                <a href="#" type="button" class="btn btn-danger btn-xs" disabled="disable">已入院</a>
                                            </td>
                                        </c:if>
                                        <c:if var="Accept" test="${in.inStatue==2}">
                                            <td>
                                                <a href="#" type="button" class="btn btn-default btn-xs" disabled="disable">已出院</a>
                                            </td>
                                        </c:if>
                                    </tr>
                                </c:forEach>
