    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                <li class="treeniew"><a href="#"> <i class="fa fa-user"></i> <span>  处方</span></a></li>
                <li class="treeview">
                <li class="treeniew"><a href="#"> <i class="fa fa-user"></i> <span>  挂号</span></a></li>
                <li class="treeview">
                <li class="treeniew"><a href="#"> <i class="fa fa-user"></i> <span>  账单</span></a></li>
                <li class="treeview">
    ...
    <div class="content-wrapper">
        ...
        <div class="pad margin no-print">
            <div class="callout callout-info" style="margin-bottom: 0!important;">
                <h4><i class="fa fa-info"></i> 最新通知:</h4>
                您最近有一个账单需要支付！
            </div>
        </div>
        ...
        <section class="invoice">
            ...
            <div class="row invoice-info">
                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${billList}" var="bil" >
                                    <tr role="row" class="odd">
                                        <td>${bil.drugInstrument.diName}</td>
                                        <td>${bil.drugInstrument.diSoldPrice}</td>
                                        <td>${bil.drugInstrument.diAmount}</td>
                                        <td>${bil.billTime}</td>
                                    </tr>
                                </c:forEach>
                ...
                <div class="row no-print">
                    <div class="col-xs-12">
                        <button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> 挂号
                        </button>
                    </div>
                </div>
        <!-- /.content -->
