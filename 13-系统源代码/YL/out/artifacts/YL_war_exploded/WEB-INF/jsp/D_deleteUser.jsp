                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="dist/img/userB.png" class="img-circle" alt="User Image">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <form action="#" method="get" class="sidebar-form">
                ...
                <button type="submit" name="search" id="search_btn" class="btn btn-flat"><i class="fa fa-search"></i>
                </button>
              </span>
                </div>
            </form>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        <form:form action="deleteUser" method="post" modelAttribute="staff">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <form:input path="userBrithday" type="text" class="form-control pull-right" id="datepicker"/>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <form:input path="userPhone" type="text" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;">
                                    <option selected="selected">住院医师</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">请确认用户删除</h3>
                        </div>
                        <div class="box-body">
                            <!-- Date -->
                            <div class="btn">
                                <button type="submit" class="btn btn-google"><b>确认删除</b></button>
                            </div>
