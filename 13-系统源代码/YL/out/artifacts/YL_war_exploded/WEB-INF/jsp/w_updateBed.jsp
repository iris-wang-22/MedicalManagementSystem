            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="/inhospital/w_updateBed">更新病房信息</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="box-body no-padding">
                            <div class="table-responsive mailbox-messages">
                                <table class="table table-hover table-striped">
                                    ...
                                    <td>${in.inEndtime}</td>
                                    <td>
                                        <a href="/inhospital/Chose?userId=${in.userId}&btn=1" type="button" class="btn btn-primary btn-sm checkbox-toggle">出院</a>
                                    </td>
                                    </tr>
                                    </c:if>
                                    </c:forEach>
