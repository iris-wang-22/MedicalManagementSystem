            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="#">安排手术</a></li>
                            </ul>
                        </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form:form action="deleteop" method="post" modelAttribute="viewop">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">请确认删除手术</h3>
                                    </div>
                                    <div class="box-body">
                                        <!-- Date -->
                                        <div class="btn">
                                            <button type="submit" class="btn btn-sm"><b>完成手术删除</b></button>
                                        </div>
