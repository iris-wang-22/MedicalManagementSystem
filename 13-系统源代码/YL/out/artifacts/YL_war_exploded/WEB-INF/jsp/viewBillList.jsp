...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <font color="#8b0000" >支付</font>
                <div class="btn-group">
                    <button type="button" class="btn btn-default"><b>查看待支付账单</b></button>
                    <button type="button" class="btn btn-default"><b>查看已支付账单</b></button>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><b>待支付账单</b></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${billList}" var="bil" >
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${bil.drugInstrument.diSoldPrice}*${bil.drugInstrument.diAmount}</td>
                    ...
                    <button type="button" class="btn btn-primary btn-sm checkbox-toggle">  支付  </button>
                    <!-- /.box -->
                </div>
                <!-- /.col -->
            </div>
