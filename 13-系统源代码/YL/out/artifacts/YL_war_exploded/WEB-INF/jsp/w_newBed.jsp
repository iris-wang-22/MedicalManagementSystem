    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">安排住院</a></li>
            </ol>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><b>待住院信息表</b></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${inhospitalList}" var="in" >
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${in.user.userPhone}</td>
                                        <td>${in.bedId}</td>
                                        <td>${in.inStarttime}</td>
                                        <td>
                                            <a href="/inhospital/ins?userId=${in.userId}" type="button" class="btn btn-danger btn-xs" >修改</a>
