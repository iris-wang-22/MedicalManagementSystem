        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#">权限管理</a></li>
                        <li class="active"><a href="/staff/D_staffRegister">职工注册</a></li>
                        <li><a href="#">资料修改</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="row">
                    <form:form action="D_staffRegister" method="post" modelAttribute="staff">
                        <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <form:input path="userPassword" type="password" class="form-control" value="888"/>
                        </div>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">请确认安排信息填写</h3>
                        </div>
                        <div class="box-body">
                            <!-- Date -->
                            <div class="btn">
                                <button type="submit" class="btn btn-google"><b>确认注册</b></button>
                            </div>
                        </div>
                        <!-- /.form group -->
