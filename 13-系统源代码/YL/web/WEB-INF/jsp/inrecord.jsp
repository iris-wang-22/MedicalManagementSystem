...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>药品/仪器出入库管理</a></li>
                <li class="active">进货入库</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form:form action="inrecord" method="post" modelAttribute="drugInstrument">
