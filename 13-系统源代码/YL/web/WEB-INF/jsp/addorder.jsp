...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>采购管理</a></li>
                <li class="active">添加采购计划</li>
            </ol>
        </section>
                        ...
                        <div class="col-md-6">
                            ...
                            <form:form action="addorder" method="post" modelAttribute="order">
                                <div class="form-group">
                                    <label for="orderdate" class="col-sm-3 control-label">申请日期：</label>
                                    <div class="col-sm-8">
                                        <form:input path="orderDate" type="date" class="form-control" id="orderdate" placeholder="yyyy-mm-dd"/>
                                        <%--<input name="oDate" type="text" class="form-control" id="orderdate" placeholder="yyyy/mm/dd"/>--%>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="orderid" class="col-sm-3 control-label">编号：</label>
                                    <div class="col-sm-8">
                                        <form:textarea path="orderId" type="number" id="orderid" class="form-control" placeholder="XXX"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="diid" class="col-sm-3 control-label">药品编号：</label>
                                    <div class="col-sm-8">
                                        <form:input path="diId" type="number" id="diid" class="form-control" placeholder="XXX"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="diname" class="col-sm-3 control-label">药品名称：</label>
                                    <div class="col-sm-8">
                                        <form:input path="drugInstrument.diName" type="text" id="diname" class="form-control" placeholder="药品名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="diamount" class="col-sm-3 control-label">数量：</label>
                                    <div class="col-sm-8">
                                        <form:input path="drugInstrument.diAmount" type="number" id="diamount" class="form-control" placeholder="XXXX"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="orderStatue" class="col-sm-3 control-label">采购计划状态：</label>
                                    <div class="col-sm-8">
                                        <form:input path="orderStatue" type="number" id="orderstate" class="form-control" placeholder="X"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="username" class="col-sm-3 control-label">负责人：</label>
                                    <div class="col-sm-8">
                                        <form:input path="userName" type="text" id="username" class="form-control" placeholder="负责人"/>
                                    </div>
                                </div>
                                    <!-- /.col -->
                                    <div class="col-xs-6">
...
<script src="${ctxStatic}/plugins/atatables/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
...
<!-- AdminLTE App -->
<script src="${ctxStatic}/plugins/dist/js/app.min.js"></script>
<!-- page script -->
<script>
    $(function () {
        $("#example1").DataTable();
