        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="/viewop/D_viewOp">查看待手术信息</a></li>
                                <li><a href="#">安排手术</a></li>
                            </ul>
                        </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">查看待手术信息</a></li>
            </ol>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><b>待手术信息表</b></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                <c:forEach items="${OperationList}" var="op" >
                                    <tr role="row" class="odd">
                                        <td>${op.medicalRecord.user.userName}</td>
                                        <td>${op.medicalRecord.user.userSex}</td>
                                        <td>${op.medicalRecord.userUserId}</td>
                                        <td>${op.opPlace}</td>
                                        <td>${op.opTime}</td>
                                        <td>
                                            <a href="/viewop/planop?opId=${op.opId}" type="button" class="btn btn-danger btn-xs" >修改</a>

                                        </td>
                                        <td>
                                            <a href="/viewop/deleteop?opId=${op.opId}" type="button" class="btn btn-default btn-xs" >删除</a>
